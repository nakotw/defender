...
Write-Host ""
Write-Host "`tTool    :: Check ASR configuration and defender exclusions" -ForegroundColor Magenta
...
Write-Host 
write-host -foregroundcolor $warningmessagecolor "====================================== ASR rules Exclusions ======================================`n"

get-mppreference | select-object -expandproperty AttackSurfaceReductionOnlyExclusions

Write-Host 
write-host -foregroundcolor $warningmessagecolor "====================================== ASR per rules Exclusions ======================================`n"

Get-MpPreference | select AttackSurfaceReductionRules_RuleSpecificExclusions, AttackSurfaceReductionRules_RuleSpecificExclusions_Id
